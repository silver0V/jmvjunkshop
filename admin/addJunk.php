            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
              <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                  ...
                  <h3 class="mb-5">Add Junk Material</h3>
                    
                  <form action="addJ.php" method="post">
                    <div class="form-outline mb-4">
                        <label class="form-label-lg">Image File Name</label><br>
                        <input type="text" name="img" class="form-control form-control-lg" placeholder="xx.jpg"/>
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <input type="text" name="junkName" class="form-control form-control-lg" placeholder="Junk Name"/>
                      </div>

                      <div class="form-outline mb-4">
                        <label class="form-label">Junk Description</label>
                        <input type="text" name="junkDesc" class="form-control form-control-lg" placeholder="Junk Description"/>
                      </div>
